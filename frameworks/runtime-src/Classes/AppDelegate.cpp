...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    CCLOG("Run %d", engine->getLuaStack()->executeString("a = 1"));
    CCLOG("Run %d", engine->getLuaStack()->executeString("local b == 1"));
    CCLOG("Run %d", engine->getLuaStack()->executeString("require \"struct\""));
